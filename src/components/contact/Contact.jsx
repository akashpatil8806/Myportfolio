  ...
  return (
    <section id="contact">
      ...
      <div className="container contact__container">
        ...
        <h4>Email</h4>
        <h5>akashgpatil8806@gmail.com</h5>
        <a href='mailto:akashgpatil8806@gmail.com' target="_blank" rel='noreferrer'>Send a messsage</a>
        </article>
        <article className="contact__option">
          <BsLinkedin className='contact__option-icon'/>
        <h4>LinkedIn</h4>
        {/* <h5>kartik97gaikwad@gmail.com</h5> */}
        <a href='https://www.linkedin.com/in/akash-patil-409833269' target="_blank" rel='noreferrer'>Send a messsage</a>
        </article>
        <article className="contact__option">
